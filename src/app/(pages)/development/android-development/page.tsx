...
import { android_development } from '@/data/dummy'
...
const page = () => {
  ...
  return (
    <div className='px-28 py-10'>
       <h1 className='text-[2.5rem] font-bold'>Complete <span className='text-purple-500 italic'>Android Development</span> Roadmap & Resources.</h1>
        <div className="flex mt-6 flex-wrap gap-5 justify-start">
          {
            android_development.map((subject,i)=>(
